...
//		paint.setColor(isOn ? context.getResources().getColor(R.color.main_red)0xff4bd763 : 0xffe3e3e3);
		paint.setColor(isOn ? context.getResources().getColor(R.color.bg_blue): 0xffe3e3e3);
		...
		canvas.scale(0.98f, 0.98f, bWidth / 3, bWidth / 3);
		paint.setStyle(Style.FILL);
		paint.setColor(0xffffffff);
		canvas.drawPath(bPath, paint);
		...
		paint.setColor(isOn ? context.getResources().getColor(R.color.bg_blue) : 0xffbfbfbf);
		canvas.drawPath(bPath, paint);
