 ...
 * Description：
 */
public class ReportSpRaTwoAdapter extends BaseMultiItemQuickAdapter<TestBean, BaseViewHolder> {
    private Context mContext;

    public ReportSpRaTwoAdapter(Context context, List<TestBean> data) {
        super(data);
        ...
        addItemType(Constant.ITEM_TYPE_TV_TV_TV_TV, R.layout.item_tv_tv_tv_tv);
        addItemType(Constant.ITEM_TYPE_TV_EV_B, R.layout.item_tv_et_b);
    ...
    protected void convert(BaseViewHolder helper, TestBean item) {
        switch (helper.getItemViewType()) {
            ...
            case Constant.ITEM_TYPE_ET:
                ...
                break;
            case Constant.ITEM_TYPE_TV_TV_TV_TV:
                break;
            case Constant.ITEM_TYPE_TV_EV_B:
                helper.setText(R.id.tv_01, item.getTitle());
                break;
