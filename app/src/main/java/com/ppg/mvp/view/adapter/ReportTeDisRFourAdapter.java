 ...
 * Description：
 */
public class ReportTeDisRFourAdapter extends BaseMultiItemQuickAdapter<TestBean, BaseViewHolder> {
    private Context mContext;

    public ReportTeDisRFourAdapter(Context context, List<TestBean> data) {
        super(data);
