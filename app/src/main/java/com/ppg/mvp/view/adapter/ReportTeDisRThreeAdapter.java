 ...
 * Description：
 */
public class ReportTeDisRThreeAdapter extends BaseMultiItemQuickAdapter<TestBean, BaseViewHolder> {
    private Context mContext;

    public ReportTeDisRThreeAdapter(Context context, List<TestBean> data) {
        super(data);
