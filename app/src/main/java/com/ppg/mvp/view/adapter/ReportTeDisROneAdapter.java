 ...
 * Description：
 */
public class ReportTeDisROneAdapter extends BaseMultiItemQuickAdapter<TestBean, BaseViewHolder> {
    private Context mContext;

    public ReportTeDisROneAdapter(Context context, List<TestBean> data) {
        super(data);
