 ...
 * 项目信息
 */
public class ReportSpRaTwoActivity extends BaseActivity{
...
//    private String[] et02 = {"上海喜来登大酒店", "刘三妹", "13666666666", "上海xx路xx号", "小高层", "12354565.89平米","",""};
    ...
    private String[] tv01 ={"项目问题","更改情况及结果"};
    private String[] et02 ={"",""};
    @Override
    ...
    protected void initListener() {
        ...
        recyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(ReportSpRaTwoActivity.this, ReportSpRaTwoOneActivity.class);
    ...
    private void getData() {
        ...
        if (tv01.length == et02.length) {
            for (int i = 0; i < 2; i++) {
                ...
                switch (i) {
                    case 0:
                        textBeanList.add(new TestBean(Constant.ITEM_TYPE_TV_TV_TV_TV, tv01[i], et02[i]));
