...
public class ReportSpRaActivity extends BaseActivity {
    ...
    private ReportSpRaAdapter mAdapter;
    private String[] tv01 = {"项目信息：", "测试部门：", "基面情况：", "汗水率：", "碱性：", "测试日期：", "天气：", "温度：", "湿度：", "产品体积&比重：", "底漆测试结果：", "面漆中层结果（第一次）：", "面漆中层结果（第二次）：", "罩面漆测试结果", "保存"};
    private String[] et02 = {"上海喜来登大酒店", "请输入销售代表信息", "请输入基面情况", "请输入汗水率信息", "请输入碱性信息", "2017-10-23", "晴", "23","79%", "查看详情", "查看详情", "查看详情", "查看详情", "查看详情", ""};
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                switch (position) {
                    ...
                    case 10:
                        ...
                        strings_titles1.add("测试部位长度L(m)");
                        strings_titles1.add("测试部位宽度L(m)");
                        strings_titles1.add("涂刷面积S=L*W(m)");
